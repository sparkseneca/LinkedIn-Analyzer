    ...
    if uploaded_file is not None:
        try:
            ...
            fig_comp = px.bar(
                top_comp[::-1],
                orientation="h",
                labels={"value": "Connections", "index": "Company"},
            )
            ...
            fig_sen = px.bar(
                seniority_dist[::-1],
                orientation="h",
                labels={"value": "Connections", "index": "Seniority"},
            )
            ...
            if df["Connected On"].notna().any():
                ...
                fig_time = px.bar(
                    by_month, labels={"value": "Connections", "index": "Month"}
                )
